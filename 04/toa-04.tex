...
観光用飛行機が高度5キロメートルからツアーを開始します。乗客は1分ごとに次の1分間上昇するか、下降するかを決めることができます。どちらも1分でちょうど1キロ上昇するか下降します。60分後(60回の進路変更後)に元の高度に戻ってこなければならないとすると、飛行経路は何通りあるでしょう。高度0キロメートルで墜落します。
\end{frame}
